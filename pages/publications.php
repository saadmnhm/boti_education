        ...
        <div class="row" id="blogGrid">
            <div class="col-lg-4 col-md-6 blog-card" data-category="education">
                <div class="blog-card-inner">
                    <a href="<?php echo URL::base() ?>publications/la-transformation"><img src="<?php echo URL::base() ?>assets/images/blog_img1.png" alt="Blog 1" class="blog-image" ></a>
                    <div class="blog-content">
                        ...
                        <a href="<?php echo URL::base() ?>publications/la-transformation"><h3 class="blog-title">La transformation numérique des écoles africaines</h3></a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 blog-card" data-category="digital">
                <div class="blog-card-inner">
                    <a href="<?php echo URL::base() ?>publications/la-transformation"><img src="<?php echo URL::base() ?>assets/images/blog_img2.png" alt="Blog 2" class="blog-image" ></a>
                    <div class="blog-content">
                        <div class="blog-meta">
                        ...
                        <a href="<?php echo URL::base() ?>publications/la-transformation"><h3 class="blog-title">Comment digitaliser votre établissement scolaire</h3></a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 blog-card" data-category="technology">
                <div class="blog-card-inner">
                    <a href="<?php echo URL::base() ?>publications/la-transformation"><img src="<?php echo URL::base() ?>assets/images/blog_img3.png" alt="Blog 3" class="blog-image" ></a>
                    <div class="blog-content">
                        <div class="blog-meta">
                        ...
                        <a href="<?php echo URL::base() ?>publications/la-transformation"><h3 class="blog-title">Les nouvelles technologies au service de l'éducation</h3></a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 blog-card" data-category="education">
                <div class="blog-card-inner">
                    <a href="<?php echo URL::base() ?>publications/la-transformation"><img src="<?php echo URL::base() ?>assets/images/blog_img1.png" alt="Blog 4" class="blog-image" ></a>
                    <div class="blog-content">
                        <div class="blog-meta">
                            <span class="blog-tag education">Education</span>
                            <span class="blog-time">
                        ...
                        <a href="<?php echo URL::base() ?>publications/la-transformation"><h3 class="blog-title">BOTI School: Révolutionner la gestion scolaire</h3></a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 blog-card" data-category="innovation">
                <div class="blog-card-inner">
                    <a href="<?php echo URL::base() ?>publications/la-transformation"><img src="<?php echo URL::base() ?>assets/images/blog_img2.png" alt="Blog 5" class="blog-image" ></a>
                    <div class="blog-content">
                        <div class="blog-meta">
                        ...
                        <a href="<?php echo URL::base() ?>publications/la-transformation"><h3 class="blog-title">Innovation pédagogique: Les tendances de 2026</h3></a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 blog-card" data-category="management">
                <div class="blog-card-inner">
                    <img src="<?php echo URL::base() ?>assets/images/blog_img3.png" alt="Blog 6" class="blog-image" >
                    <div class="blog-content">
                        <div class="blog-meta">
            ...
            <div class="col-lg-4 col-md-6 blog-card" data-category="digital">
                <div class="blog-card-inner">
                    <img src="<?php echo URL::base() ?>assets/images/blog_img1.png" alt="Blog 7" class="blog-image" >
                    <div class="blog-content">
                        <div class="blog-meta">
                            <span class="blog-tag digital">Digital</span>
                            <span class="blog-time">
            ...
            <div class="col-lg-4 col-md-6 blog-card" data-category="technology">
                <div class="blog-card-inner">
                    <img src="<?php echo URL::base() ?>assets/images/blog_img2.png" alt="Blog 8" class="blog-image" >
                    <div class="blog-content">
                        <div class="blog-meta">
                            <span class="blog-tag technology">Technology</span>
                            <span class="blog-time">
            ...
            <div class="col-lg-4 col-md-6 blog-card" data-category="innovation">
                <div class="blog-card-inner">
                    <img src="<?php echo URL::base() ?>assets/images/blog_img3.png" alt="Blog 9" class="blog-image" >
                    <div class="blog-content">
                        <div class="blog-meta">
                            <span class="blog-tag innovation">Innovation</span>
                            <span class="blog-time">
