...
<div class="background_color1">
    <header class="site-header" id="mainHeader">
      <div class="header-bar">
        ...
        <button class="btn-contact d-none d-lg-block" id="openStepperBtn">Contacts-nous</button>
        ...
        <div class="stepper-container container ">
            ...
            <div class="step step-1 active">
                ...
                <div class="cards-container">
                    <div class="card" data-value="option1">
                        <div>
                    ...
                    <div class="card" data-value="option2">
                        <div>
